...
document.addEventListener("LayoutBuilt", () => 
{
    ...
    Router.addRoute("about", "../Home/about.html");
    Router.addRoute("contact", "../Home/contact.html");
    ...
    Router.addRoute("login","../Auth/login.html", "./Authentecation/login.js", "../../stylesheets/Auth/login.css");
    Router.addRoute("register","../Auth/register.html", "./Authentecation/register.js", "../../stylesheets/Auth/login.css")
